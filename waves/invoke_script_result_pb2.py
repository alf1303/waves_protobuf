...
_INVOKESCRIPTRESULT = DESCRIPTOR.message_types_by_name['InvokeScriptResult']
_INVOKESCRIPTRESULT_PAYMENT = _INVOKESCRIPTRESULT.nested_types_by_name['Payment']
_INVOKESCRIPTRESULT_ISSUE = _INVOKESCRIPTRESULT.nested_types_by_name['Issue']
_INVOKESCRIPTRESULT_REISSUE = _INVOKESCRIPTRESULT.nested_types_by_name['Reissue']
_INVOKESCRIPTRESULT_BURN = _INVOKESCRIPTRESULT.nested_types_by_name['Burn']
_INVOKESCRIPTRESULT_SPONSORFEE = _INVOKESCRIPTRESULT.nested_types_by_name['SponsorFee']
_INVOKESCRIPTRESULT_LEASE = _INVOKESCRIPTRESULT.nested_types_by_name['Lease']
_INVOKESCRIPTRESULT_LEASECANCEL = _INVOKESCRIPTRESULT.nested_types_by_name['LeaseCancel']
_INVOKESCRIPTRESULT_ERRORMESSAGE = _INVOKESCRIPTRESULT.nested_types_by_name['ErrorMessage']
_INVOKESCRIPTRESULT_CALL = _INVOKESCRIPTRESULT.nested_types_by_name['Call']
_INVOKESCRIPTRESULT_CALL_ARGUMENT = _INVOKESCRIPTRESULT_CALL.nested_types_by_name['Argument']
_INVOKESCRIPTRESULT_CALL_ARGUMENT_LIST = _INVOKESCRIPTRESULT_CALL_ARGUMENT.nested_types_by_name['List']
_INVOKESCRIPTRESULT_INVOCATION = _INVOKESCRIPTRESULT.nested_types_by_name['Invocation']
